    ...
    return (<>
        <section className='pt-10 pb-10'>
            <div className="lg:flex justify-center align-center gap-10">
                ...
                {/* Info Doctor */}
                <div className='2xl:w-[750px] xl:w-[650px] lg:w-[550px] h-auto lg:p-0 sm:p-10 p-5'>
                    <div className='flex flex-col'>
                        <p className='2xl:text-6xl xl:text-5xl sm:text-2xl xl:pt-2 sm:pt-1 text-2xl pt-1'><b>Dr. Reyes Pérez, Alvaro Orlando</b></p>
                        <div className='flex gap-20 2xl:pt-3 xl:pt-2 sm:pt-1 2xl:pb-3 xl:pb-2 sm:pb-1 pt-1 pb-1'>
                            <p className='2xl:text-2xl xl:text-xl sm:text-md text-md text-gray-400'>CMP: 55124</p>
                            <p className='2xl:text-2xl xl:text-xl sm:text-md text-md text-gray-400'>RNE: 032319</p>
                        </div>
                    </div>
                    {/* Especialidades */}
                    <div className='2xl:pt-3 xl:pt-2 sm:pt-1 2xl:pb-3 xl:pb-2 sm:pb-1 pt-1 pb-1'>
                        ...
                        <div className='2xl:pt-3 xl:pt-2 sm:pt-1 pt-1'>
                            <p className="bg-blue-100 rounded-full flex justify-center items-center font-semibold 2xl:w-45 xl:w-40 sm:w-30 2xl:h-10 xl:h-9 lg:h-7 2xl:text-lg xl:text-md sm:text-sm text-sm w-30 h-7">
                                Cardiología
                            </p>
                        </div>
                    </div>
