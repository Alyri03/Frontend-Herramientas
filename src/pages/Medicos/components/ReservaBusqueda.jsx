            ...
            <div className="w-auto h-auto pt-7 sm:pt-10 md:pt-13">
                <div className="flex bg-stone-50 text-xs sm:text-sm md:text-base rounded-xl h-10" >
                    ...
                    <div className="w-full h-full">
                        <input className="w-70 sm:w-100 md:w-130 h-full focus:outline-none bg-transparent pl-2" type="text" placeholder="Busca a tu medico o escribe la especialidad"/>  
                    </div>
                </div>
            </div>
        </section>
