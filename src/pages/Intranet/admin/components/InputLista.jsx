import { Calendar, Eye, Funnel, Mail, Phone, Search } from "lucide-react";
...
const InputListaComponent = () => {
    ...
    const doctores = [
        { nombreDoc: "Juan Perez", num: "D001", especialidad: "Cardiologia", horario: "Lun-Vie, 9:00-17:00", estado: "Disponible", pacientes: "145", ubicacion: "Consultorio 1", telefono: "(555) 123-4567", correo: "dr.wilson@cliniccare.com" },
        { nombreDoc: "Maria Lopez", num: "D002", especialidad: "Pediatria", horario: "Lun-Jue, 8:00-16:00", estado: "En consulta", pacientes: "145", ubicacion: "Consultorio 2", telefono: "(555) 123-4567", correo: "dr.wilson@cliniccare.com" },
        { nombreDoc: "Carlos Sanchez", num: "D003", especialidad: "Dermatologia", horario: "Lun-Jue, 8:00-17:00", estado: "Disponible", pacientes: "145", ubicacion: "Consultorio 3", telefono: "(555) 123-4567", correo: "dr.wilson@cliniccare.com" },
        { nombreDoc: "Ana Torres", num: "D004", especialidad: "Neurologia", horario: "Lun-Jue, 8:00-16:00", estado: "Ausente", pacientes: "145", ubicacion: "Consultorio 4", telefono: "(555) 123-4567", correo: "dr.wilson@cliniccare.com" },
        { nombreDoc: "Luis Garcia", num: "D005", especialidad: "Oftalmologia", horario: "Lun-Jue, 8:00-16:00", estado: "En consulta", pacientes: "145", ubicacion: "Consultorio 5", telefono: "(555) 123-4567", correo: "dr.wilson@cliniccare.com" },
    ];
                            ...
                            <TableBody>
                                {doctores.map((doctoress, i) => (
                                    <TableRow key={i}>
                                        ...
                                        <TableCell>
                                            <div className={`w-min px-2 py-1 rounded-xl flex items-center ${doctoress.estado === "Disponible" ? "bg-black text-white"
