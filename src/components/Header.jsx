...
const Header = () => {
  ...
  return (
    ...
    <nav className="bg-white-600 w-full border-b-2 border-gray-200 mx-auto">
      ...
      <div className="max-auto flex flex-wrap items-center justify-between mx-auto p-4 border-2">

        <a href="/" className="hidden md:flex items-center space-x-3 rtl:space-x-reverse h-19 w-auto border-2">
          <img src={Logo} alt="" />
        </a>
        ...
        <button className="outline-2 outline-offset-2 px-7 py-1 rounded-xl transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 " style={{ color: "#1B669A" }}>
